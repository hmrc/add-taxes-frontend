...
class DoYouHaveActivationTokenController @Inject()(
  appConfig: FrontendAppConfig,
  override val messagesApi: MessagesApi,
  navigator: Navigator[Call],
  authenticate: AuthAction,
  serviceInfoData: ServiceInfoAction,
  formProvider: DoYouHaveActivationTokenFormProvider)
    ...
    form
      ...
      .fold(
        (formWithErrors: Form[_]) =>
          BadRequest(doYouHaveActivationToken(appConfig, formWithErrors)(request.serviceInfoContent)),
