...
class DoesBusinessHaveDirectorsOrPartnersController @Inject()(
    ...
    form
      ...
      .fold(
        (formWithErrors: Form[_]) =>
          BadRequest(doesBusinessHaveDirectorsOrPartners(appConfig, formWithErrors)(request.serviceInfoContent)),
