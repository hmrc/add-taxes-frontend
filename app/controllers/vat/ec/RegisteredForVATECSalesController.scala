...
class RegisteredForVATECSalesController @Inject()(
  ...
  def onPageLoad() = (authenticate andThen serviceInfoData) { implicit request =>
    Ok(registeredForVATECSales(appConfig, form)(request.serviceInfoContent))
  }
    ...
    form
      ...
      .fold(
        (formWithErrors: Form[_]) =>
          Future.successful(BadRequest(registeredForVATECSales(appConfig, formWithErrors)(request.serviceInfoContent))),
