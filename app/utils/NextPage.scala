...
object NextPage {
  ...
  implicit val haveYouRegisteredAEOI
    : NextPage[HaveYouRegisteredAEOIId.type, models.other.aeoi.HaveYouRegisteredAEOI] = {
    new NextPage[HaveYouRegisteredAEOIId.type, models.other.aeoi.HaveYouRegisteredAEOI] {
      override def get(
        b: models.other.aeoi.HaveYouRegisteredAEOI)(implicit appConfig: FrontendAppConfig, request: Request[_]): Call =
        b match {
          case models.other.aeoi.HaveYouRegisteredAEOI.Yes =>
  ...
  implicit val doYouHaveCharityReference
    ...
    new NextPage[DoYouHaveCharityReferenceId.type, models.other.charity.DoYouHaveCharityReference] {
      override def get(b: models.other.charity.DoYouHaveCharityReference)(
        implicit appConfig: FrontendAppConfig,
        request: Request[_]): Call =
        b match {
          case models.other.charity.DoYouHaveCharityReference.Yes =>
            Call(GET, appConfig.emacEnrollmentsUrl(Enrolments.Charity))
      ...
      override def get(b: models.other.gambling.mgd.DoYouHaveMGDRegistration)(
        ...
        b match {
          case models.other.gambling.mgd.DoYouHaveMGDRegistration.Yes =>
            Call(GET, appConfig.emacEnrollmentsUrl(Enrolments.MachineGamingDuty))
