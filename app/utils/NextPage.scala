...
object NextPage {
  ...
  implicit val doYouHaveCharityReference
    : NextPage[DoYouHaveCharityReferenceId.type, models.other.charity.DoYouHaveCharityReference] = {
    new NextPage[DoYouHaveCharityReferenceId.type, models.other.charity.DoYouHaveCharityReference] {
      override def get(
        b: models.other.charity.DoYouHaveCharityReference)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case models.other.charity.DoYouHaveCharityReference.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.Charity))
          case models.other.charity.DoYouHaveCharityReference.No =>
            charityRoutes.RegisterForCharityController.onPageLoad()
        }
    }
  }

  implicit val doYouHaveMGDRegistration
    : NextPage[DoYouHaveMGDRegistrationId.type, models.other.gambling.mgd.DoYouHaveMGDRegistration] = {
    new NextPage[DoYouHaveMGDRegistrationId.type, models.other.gambling.mgd.DoYouHaveMGDRegistration] {
      override def get(b: models.other.gambling.mgd.DoYouHaveMGDRegistration)(
        implicit urlHelper: UrlHelper,
        request: Request[_]): Call =
        b match {
          case models.other.gambling.mgd.DoYouHaveMGDRegistration.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.MachineGamingDuty))
  ...
  implicit val registeredForVATUk: NextPage[RegisteredForVATUkId.type, models.vat.moss.uk.RegisteredForVATUk] = {
    new NextPage[RegisteredForVATUkId.type, models.vat.moss.uk.RegisteredForVATUk] {
      override def get(
        b: models.vat.moss.uk.RegisteredForVATUk)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
  ...
  implicit val onlineVATAccount: NextPage[OnlineVATAccountId.type, models.vat.moss.uk.OnlineVATAccount] = {
    new NextPage[OnlineVATAccountId.type, models.vat.moss.uk.OnlineVATAccount] {
      override def get(
        b: models.vat.moss.uk.OnlineVATAccount)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
  ...
  implicit val whichPensionSchemeToAdd
    ...
    new NextPage[WhichPensionSchemeToAddId.type, models.employer.pension.WhichPensionSchemeToAdd] {
      override def get(
        b: models.employer.pension.WhichPensionSchemeToAdd)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case models.employer.pension.WhichPensionSchemeToAdd.Administrators =>
            Call(GET, urlHelper.getPortalURL("pensionAdministrators"))
          case models.employer.pension.WhichPensionSchemeToAdd.Practitioners =>
            Call(GET, urlHelper.getPortalURL("pensionPractitioners"))
        }
    }
  }
      ...
      override def get(b: models.sa.partnership.HaveYouRegisteredPartnership)(
        ...
        b match {
          case models.sa.partnership.HaveYouRegisteredPartnership.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.SAPartnership))
          case models.sa.partnership.HaveYouRegisteredPartnership.No =>
            Call(GET, urlHelper.getPublishedAssetsURL("partnershipOther"))
        }
    }
  }
      ...
      override def get(b: DoYouHaveASEEDNumber)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case DoYouHaveASEEDNumber.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.ExciseMovementControlSystem))
      ...
      override def get(b: DoYouHaveEORINumber)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case DoYouHaveEORINumber.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.EconomicOperatorsRegistration))
  ...
  implicit val ebtiEori: NextPage[DoYouHaveEORINumberId.EBTI.type, DoYouHaveEORINumber] = {
    new NextPage[DoYouHaveEORINumberId.EBTI.type, DoYouHaveEORINumber] {
      override def get(b: DoYouHaveEORINumber)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case DoYouHaveEORINumber.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.ElectronicBindingTariffInformation))
  ...
  implicit val nctsEori: NextPage[DoYouHaveEORINumberId.NCTS.type, DoYouHaveEORINumber] = {
    new NextPage[DoYouHaveEORINumberId.NCTS.type, DoYouHaveEORINumber] {
      override def get(b: DoYouHaveEORINumber)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case DoYouHaveEORINumber.Yes =>
            Call(GET, urlHelper.emacEnrollmentsUrl(Enrolments.NewComputerisedTransitSystem))
      ...
      override def get(b: FindingYourAccount)(implicit urlHelper: UrlHelper, request: Request[_]): Call =
        b match {
          case FindingYourAccount.DontKnowPassword =>
            Call(GET, urlHelper.governmentGatewayLostCredentialsUrl(ForgottenOptions.ForgottenPassword))
          case FindingYourAccount.DontKnowId =>
            Call(GET, urlHelper.governmentGatewayLostCredentialsUrl(ForgottenOptions.ForgottenId))
          case FindingYourAccount.DontKnowIdOrPassword =>
            Call(GET, urlHelper.governmentGatewayLostCredentialsUrl(ForgottenOptions.ForgottenIdAndPassword))
        }
    }
  }
