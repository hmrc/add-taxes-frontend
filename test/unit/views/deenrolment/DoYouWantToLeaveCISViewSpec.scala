...
class DoYouWantToLeaveCISViewSpec extends ViewBehaviours {
  ...
  def createView: () => HtmlFormat.Appendable = () =>
    new doYouWantToLeaveCIS(formWithCSRF, mainTemplate)(frontendAppConfig, form)(serviceInfoContent)(fakeRequest, messages)
  ...
  "DoYouWantToLeaveCIS view" must {
    ...
    "contain heading ID" in {
      ...
      doc.getElementsByTag("h1").attr("id") mustBe "do-you-want-to-leave-cis"
    }
  }
