...
class DoYouNeedToStopVatMossNUViewSpec extends ViewBehaviours {
  ...
  def createView: () => HtmlFormat.Appendable = () =>
    new doYouNeedToStopVatMossNU(formWithCSRF, mainTemplate)(frontendAppConfig, form)(serviceInfoContent)(fakeRequest, messages)
  ...
  "DoYouNeedToStopVatMossNU view" must {
    ...
    "contain heading ID" in {
      ...
      doc.getElementsByTag("h1").attr("id") mustBe "do-you-need-to-stop-vat-moss-nu"
    }
  }
