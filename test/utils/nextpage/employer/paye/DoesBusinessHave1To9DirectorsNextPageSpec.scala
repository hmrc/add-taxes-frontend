...
class DoesBusinessHave1To9DirectorsNextPageSpec extends NextPageSpecBase {

  "doesBusinessHave1To9Directors" when {
    ...
    behave like nextPage(
      NextPage.doesBusinessHave1To9Directors,
      DoesBusinessHave1To9Directors.No,
      "/business-account/add-tax/employer/directors-register-by-phone"
    )
  }
}
