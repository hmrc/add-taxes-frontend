...
class DoesYourPartnershipHave2To10PartnersNextPageSpec extends NextPageSpecBase {

  "doesYourPartnershipHave2To10Partners" when {
    ...
    behave like nextPage(
      NextPage.doesYourPartnershipHave2To10Partners,
      DoesYourPartnershipHave2To10Partners.No,
      "/business-account/add-tax/employer/partners-register-by-phone"
    )
  }
}
