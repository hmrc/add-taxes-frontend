...
class HaveYouRegisteredPartnershipFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> HaveYouRegisteredPartnership.options.head.value
  )

  val form = new HaveYouRegisteredPartnershipFormProvider()()

  "HaveYouRegisteredPartnership form" must {
