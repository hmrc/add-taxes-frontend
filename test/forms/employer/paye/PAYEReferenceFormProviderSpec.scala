...
class PAYEReferenceFormProviderSpec extends FormBehaviours with ScalaCheckDrivenPropertyChecks {
  ...
  "SAUTRFormProver" must {
    ...
    "fail for invalid characters" in {
      form
        ...
        .fold(
          formWithErrors =>
            formWithErrors.errors.flatMap(_.messages) shouldBe List("enterYourPAYEReference.officeNumber.error.format", "enterYourPAYEReference.employerPayeReference.error.format"),
