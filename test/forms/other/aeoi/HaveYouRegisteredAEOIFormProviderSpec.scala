...
import models._
import models.other.aeoi._

class HaveYouRegisteredAEOIFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> HaveYouRegisteredAEOI.options.head.value
  )

  val form = new HaveYouRegisteredAEOIFormProvider()()

  "HaveYouRegisteredAEOI form" must {
