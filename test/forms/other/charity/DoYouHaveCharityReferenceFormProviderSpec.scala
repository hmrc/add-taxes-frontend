...
import models._
import models.other.charity._

class DoYouHaveCharityReferenceFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> DoYouHaveCharityReference.options.head.value
  )

  val form = new DoYouHaveCharityReferenceFormProvider()()

  "DoYouHaveCharityReference form" must {
