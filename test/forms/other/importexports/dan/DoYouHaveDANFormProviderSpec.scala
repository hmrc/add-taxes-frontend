...
import models._
import models.other.importexports.dan._

class DoYouHaveDANFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> DoYouHaveDAN.options.head.value
  )

  val form = new DoYouHaveDANFormProvider()()

  "DoYouHaveDAN form" must {
