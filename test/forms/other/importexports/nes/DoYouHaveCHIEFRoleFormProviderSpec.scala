...
import models._
import models.other.importexports.nes._

class DoYouHaveCHIEFRoleFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> DoYouHaveCHIEFRole.options.head.value
  )

  val form = new DoYouHaveCHIEFRoleFormProvider()()

  "DoYouHaveCHIEFRole form" must {
