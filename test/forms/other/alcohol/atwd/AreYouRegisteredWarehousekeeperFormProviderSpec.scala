...
import models._
import models.other.alcohol.atwd._

class AreYouRegisteredWarehousekeeperFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> AreYouRegisteredWarehousekeeper.options.head.value
  )

  val form = new AreYouRegisteredWarehousekeeperFormProvider()()

  "AreYouRegisteredWarehousekeeper form" must {
