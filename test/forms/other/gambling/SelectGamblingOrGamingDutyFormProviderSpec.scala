...
import models._
import models.other.gambling._

class SelectGamblingOrGamingDutyFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> SelectGamblingOrGamingDuty.options.head.value
  )

  val form = new SelectGamblingOrGamingDutyFormProvider()()

  "SelectGamblingOrGamingDuty form" must {
