...
import models._
import models.other.gambling.gbd._

class AreYouRegisteredGTSFormProviderSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> AreYouRegisteredGTS.options.head.value
  )

  val form = new AreYouRegisteredGTSFormProvider()()

  "AreYouRegisteredGTS form" must {
