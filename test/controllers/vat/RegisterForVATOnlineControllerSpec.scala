...
class RegisterForVATOnlineControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) =
    registerForVATOnline(frontendAppConfig, form)(HtmlFormat.empty)(fakeRequest, messages).toString
  ...
  "RegisterForVATOnline Controller" must {
    ...
    "redirect to the next page when valid data is submitted" in {
      val postRequest = fakeRequest.withFormUrlEncodedBody(("value", RegisterForVATOnline.options.head.value))
