...
class WasTurnoverMoreAfterVATViewSpec extends ViewBehaviours {
  ...
  def createView = () => wasTurnoverMoreAfterVAT(frontendAppConfig, form)(serviceInfoContent)(fakeRequest, messages)

  def createViewUsingForm =
    (form: Form[_]) => wasTurnoverMoreAfterVAT(frontendAppConfig, form)(serviceInfoContent)(fakeRequest, messages)
