...
class DoYouNeedToLeaveVATMOSSViewSpec extends ViewBehaviours {
  ...
  def createView = () => doYouNeedToLeaveVATMOSS(frontendAppConfig, form)(serviceInfoContent)(fakeRequest, messages)

  def createViewUsingForm =
    (form: Form[_]) => doYouNeedToLeaveVATMOSS(frontendAppConfig, form)(serviceInfoContent)(fakeRequest, messages)
