...
echo "GET        /doYouHaveASEEDNumber               controllers.DoYouHaveASEEDNumberController.onPageLoad()" >> ../conf/app.routes
echo "POST       /doYouHaveASEEDNumber               controllers.DoYouHaveASEEDNumberController.onSubmit()" >> ../conf/app.routes
