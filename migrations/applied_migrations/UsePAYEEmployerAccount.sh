...
echo "GET        /employer/cis/uk/contractor/epaye/other-account                       controllers.employer.cis.uk.contractor.UsePAYEEmployerAccountController.onPageLoad()" >> ../conf/app.routes
...
echo "usePAYEEmployerAccount.notnow = I want to add CIS in this account" >> ../conf/messages.en
...
echo "usePAYEEmployerAccount.notnow = Rwyf eisiau ychwanegu CIS yn y cyfrif hwn" >> ../conf/messages.cy
