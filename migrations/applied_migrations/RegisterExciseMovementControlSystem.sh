...
echo "GET        /registerExciseMovementControlSystem                       controllers.other.importexports.emcs.RegisterExciseMovementControlSystemController.onPageLoad()" >> ../conf/app.routes
